...
plot(times, Feb2007$Global_active_power, type = "l", xlab = "", ylab = "Global_active_power")
plot(times, Feb2007$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(times, Feb2007$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab="datetime")
dev.off()